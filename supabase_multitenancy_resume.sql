...
-- !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
-- This file was the multi-tenancy migration resume script and is retained
-- in full for historical reference. It contains a scan_events policy
-- definition that is now stale relative to the live hardened state.
--
